...
from .components.compose.cli_wrapper import ComposeCLI
from .components.config.cli_wrapper import ConfigCLI
from .components.container.cli_wrapper import ContainerCLI
from .components.context.cli_wrapper import ContextCLI
from .components.image.cli_wrapper import ImageCLI
from .components.manifest.cli_wrapper import ManifestCLI
from .components.network.cli_wrapper import NetworkCLI
from .components.node.cli_wrapper import NodeCLI
from .components.plugin.cli_wrapper import PluginCLI
from .components.secret.cli_wrapper import SecretCLI
from .components.service.cli_wrapper import ServiceCLI
from .components.stack.cli_wrapper import StackCLI
from .components.swarm.cli_wrapper import SwarmCLI
from .components.system.cli_wrapper import SystemCLI
from .components.task.cli_wrapper import TaskCLI
from .components.trust.cli_wrapper import TrustCLI
from .components.volume.cli_wrapper import VolumeCLI
...
class DockerClient(DockerCLICaller):
    ...
    def version(self) -> Dict:
        """
        Retrieves the docker client and engine versions.
